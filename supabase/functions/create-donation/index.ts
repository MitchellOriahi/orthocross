...
serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [
        {
          price_data: {
            currency: "usd",
            product_data: {
              name: "Donation to OrthoCross",
              description: "Support the OrthoCross app and help spread the Gospel",
            },
      ...
      mode: "payment",
      success_url: `${req.headers.get("origin")}/dashboard?donation=success`,
