...
export const HistoryHighlightIntro = () => {
  ...
  return (
    <Dialog open={isOpen}>
      <DialogContent className="sm:max-w-md mx-auto w-[calc(100%-2rem)] max-w-[calc(100%-2rem)]" onInteractOutside={(e) => e.preventDefault()} onEscapeKeyDown={(e) => e.preventDefault()}>
