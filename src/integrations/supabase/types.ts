  ...
  public: {
    Tables: {
      ...
      friend_request_notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "friend_request_notifications_request_id_fkey"
            columns: ["request_id"]
            isOneToOne: false
      ...
      group_invitation_notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "group_invitation_notifications_invitation_id_fkey"
      ...
      group_monthly_rankings: {
        ...
        Relationships: [
          {
            foreignKeyName: "group_monthly_rankings_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
      ...
      pinned_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "pinned_groups_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
