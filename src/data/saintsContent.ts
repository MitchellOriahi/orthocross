...
export const saintsContent: SaintDetail[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Severus believed that the Council of Chalcedon's formula of 'two natures in Christ' after the union threatened the unity of Christ's person. Following Cyril of Alexandria, he advocated for the formula 'one nature of God the Word incarnate,' emphasizing that after the Incarnation, Christ's humanity and divinity were inseparably united in one nature.",
      
      "In 508 AD, Severus led a delegation of monks to Constantinople to petition Emperor Anastasius I regarding the christological controversies. His theological acumen and eloquence impressed the emperor. The patriarch of Constantinople at the time, Macedonius, who supported Chalcedon, was deposed, and Severus gained influence at court.",
      
      "In 512 AD, Severus was chosen as Patriarch of Antioch, one of the most important sees in Christianity. As patriarch, he worked to unite the Church on the basis of pre-Chalcedonian christology. He was a brilliant preacher, administrator, and theologian. His 125 'Cathedral Homilies' remain treasures of Syriac Christian literature.",
      
      "Severus's patriarchate was tumultuous. When Emperor Justin I succeeded Anastasius in 518 AD, imperial policy shifted to support Chalcedon. Severus was deposed and fled to Egypt in 518 AD. He spent the remaining 20 years of his life in exile in Egypt, continuing to write extensively and guide the anti-Chalcedonian movement through letters and theological works.",
      
      "Despite condemnation by the Byzantine Church and imperial authorities, Severus remained resolute in his christological position. He wrote numerous theological treatises defending his understanding of Christ's nature. He emphasized that his theology aimed to protect the reality of the Incarnation and Christ's saving work. He died in Egypt on February 8, 538 AD. The Oriental Orthodox Churches venerate him as a saint and pillar of orthodoxy, and his theological legacy profoundly shaped the Syriac, Coptic, Armenian, and Ethiopian Orthodox traditions. His feast day is celebrated on February 8th."
    ]
  },
  {
    id: "theotokos",
