...
// Per-slide artwork (public-domain icons from Wikimedia Commons; credit = source work)
import eo1Pentecost from "@/assets/history/slides/eo1-pentecost.jpg";
import eo1Apostles from "@/assets/history/slides/eo1-apostles.jpg";
import eo1Ignatius from "@/assets/history/slides/eo1-ignatius.jpg";
import eo1Polycarp from "@/assets/history/slides/eo1-polycarp.png";
      ...
      islands: [
        {
          ...
          // Keyed by paragraph index of the reading below
          slideImages: {
            0: { src: eo1Pentecost, alt: "Icon of the Descent of the Holy Spirit at Pentecost", credit: "Novgorod icon, public domain" },
            1: { src: eo1Apostles, alt: "Icon of the Synaxis of the Twelve Apostles", credit: "Constantinople, early 14th c., public domain" },
            2: { src: earlyCatacombs, alt: "Early Christian catacombs where persecuted believers worshipped" },
            3: { src: eo1Ignatius, alt: "Saint Ignatius of Antioch, from the Menologion of Basil II", credit: "Menologion of Basil II, c. 1000 AD, public domain" },
            4: { src: eo1Polycarp, alt: "Saint Polycarp of Smyrna, from the Menologion of Basil II", credit: "Menologion of Basil II, c. 1000 AD, public domain" },
          },
